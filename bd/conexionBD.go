...
var clientOptions = options.Client().ApplyURI("mongodb+srv://sanalegon:<1234>@cluster0.r1dct.mongodb.net/myFirstDatabase?retryWrites=true&w=majority") // var que me permite setear la url de la base de datos
